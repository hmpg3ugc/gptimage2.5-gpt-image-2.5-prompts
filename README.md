# GPT Image 2.5 API (gpt-image-2.5 / gptimage2.5) — prompts guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-26cb71)** · **[Get an API key](https://go.apimart.ai/k-e3b42a)**
